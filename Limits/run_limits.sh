...
#combineTool.py -M Asymptotic -t -1 -d "$PATTERN"/workspace.root --there --parallel 15
...
#nice -n 10 combineTool.py -M AsymptoticLimits -t -1 -d $DIR/SMS-TStauStau_MStau-*/workspace.root --there --parallel 20
nice -n 10 combineTool.py -M AsymptoticLimits -d $DIR/SMS-TStauStau_MStau-*/workspace.root --there --parallel 20
