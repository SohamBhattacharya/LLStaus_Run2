...
./plot_deltaNLL_DisTauSF.py \
--input /home/soham/mnt/desy_dust/sobhatta/work/LongLivedStaus/LLStaus_Run2/Limits/results/DisTauSF/DisTauSF_mass_nbins1-60-80/DisTauSF/channels_all/eras_${ERA}/ZMT_wp-p*_dxy-gt-0p*/scan/higgsCombine.DisTauSF.MultiDimFit.mH120.root \
--output results/DisTauSF/DisTauSF_mass_nbins1-60-80/DisTauSF/channels_all/eras_${ERA}/scan/deltaNLL.root \
--era ${ERA} \
