...
./plot_prefit-postfit_DisTauSF.py \
--input /home/soham/mnt/desy_dust/sobhatta/work/LongLivedStaus/LLStaus_Run2/Limits/results/DisTauSF/DisTauSF_mass_nbins1-60-80${SUFFIX}/DisTauSF/channels_all/eras_${ERA}/ZMT_wp-p*/postfit_s.root \
--outdir results/DisTauSF/DisTauSF_mass_nbins1-60-80${SUFFIX}/DisTauSF/channels_all/eras_${ERA}/prefit-postfit \
--era ${ERA} \
--channels mutau
